...
/* =========================================================
   COURSE DATA
   CHANGE ONLY THESE DETAILS FOR A NEW COURSE
========================================================= */

const courseVideoId = "aefmZY3wrW4";

const lessons = [

    {
        id: "680eee897386b",
        title: "ASUS ROG Strix Scar 17 2021 coming on with no picture, another shop broke the laptop, can i fix it?",
        start: 0,
        end: null
    }
...
function playCurrentLesson() {
    ...
    /*
       ...
       this lesson, continue from there.
    */
...
function handleLessonEnd() {
    ...
    /*
       A single lesson has no next chapter.
       Play All therefore simply stops when
